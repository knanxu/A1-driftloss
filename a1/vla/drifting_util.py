"""Drifting loss for PyTorch.

Ported from https://github.com/phamtrongthang123/Isaac-GR00T-drifting-loss
"""
...
def drift_loss(gen, fixed_pos, fixed_neg=None, weight_gen=None, weight_pos=None,
    ...
    Args:
        ...
        fixed_neg: [B, C_n, S] negative samples (optional)
    ...
    mask_val = 100.0
    diag_mask = torch.eye(C_g, dtype=gen.dtype, device=gen.device)
    ...
    scale_inputs = scale_inputs.detach() if isinstance(scale_inputs, torch.Tensor) else scale_inputs
